function net = cnnbp(net, y)
    n = numel(net.layers); %number of layers
    ...
    %%  backprop deltas
    net.od = net.e .* (net.o .* (1 - net.o));   %  output delta % 输出层的 灵敏度 或者 残差
    net.fvd = (net.ffW' * net.od);              %  feature vector delta % 残差 反向传播回 前一层
    ...
    for l = (n - 1) : -1 : 1
        ...
        elseif strcmp(net.layers{l}.type, 's')
            for i = 1 : numel(net.layers{l}.a) % Number of feature maps in layer {l}
                z = zeros(size(net.layers{l}.a{1}));
                for j = 1 : numel(net.layers{l + 1}.a) % Number of feature map in layer {l+1}
